...
// =================== MQTT SERVER ===================
const char* mqttServer = "2.tcp.eu.ngrok.io"; //make sure it's the correct server address and that it's not expired.
const int mqttPort = 17316; //make sure it's the correct port address and that it's not expired.
